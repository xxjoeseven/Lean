...
class DataDictionary(QuantConnect.ExtendedDictionary[T], System.Collections.IEnumerable, System.Collections.Generic.ICollection[KeyValuePair[Symbol, T]], QuantConnect.Interfaces.IExtendedDictionary[Symbol, T], System.Collections.Generic.IDictionary[Symbol, T], System.Collections.Generic.IEnumerable[KeyValuePair[Symbol, T]]):
    """
    DataDictionary[T]()
...
class Delistings(QuantConnect.Data.Market.DataDictionary[Delisting], System.Collections.IEnumerable, System.Collections.Generic.ICollection[KeyValuePair[Symbol, Delisting]], QuantConnect.Interfaces.IExtendedDictionary[Symbol, Delisting], System.Collections.Generic.IDictionary[Symbol, Delisting], System.Collections.Generic.IEnumerable[KeyValuePair[Symbol, Delisting]]):
    """
...
class Dividends(QuantConnect.Data.Market.DataDictionary[Dividend], System.Collections.IEnumerable, System.Collections.Generic.ICollection[KeyValuePair[Symbol, Dividend]], QuantConnect.Interfaces.IExtendedDictionary[Symbol, Dividend], System.Collections.Generic.IDictionary[Symbol, Dividend], System.Collections.Generic.IEnumerable[KeyValuePair[Symbol, Dividend]]):
    """
